...
class _DisasterStatisticsPageState extends State<DisasterStatisticsPage>
  ...
  int _currentTabIndex = 0; // Initialisé à 0 (premier onglet)
  ...
  @override
  Widget build(BuildContext context) {
    final double tabBarViewHeight = _currentTabIndex == 2 ? 220.0 : 350.0; // 280 pour la carte, 350 pour les graphiques
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            // Contenu des onglets
            SizedBox(
              height: tabBarViewHeight, // Hauteur fixe pour les contenus des onglets
              child: TabBarView(
                controller: _tabController,
                children: [
                  _buildLineChartTab(),
