            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      // final Widget Function(TextEditingController? controller,FocusNode focusNode, onChanged: (String value) {{}) widgetBuilder;
                      if (widget.inputFiled != null)
                        widget.inputFiled!(_searchController, _focusNode, (
                          String value,
                        ) {
